...
<body>
    ...
    <section class="content-section">
        <h1>Current B.Tech Students</h1>
        
        <!-- Year Selection Buttons -->
        <div class="year-buttons">
            <form method="GET" action="btech_students.php">
        ...
        if (isset($_GET['year'])) {
            ...
            $sql = "SELECT id, roll_no, name, email FROM btech_students WHERE year = ?";
